# Django settings for vimeo_assignment project.
...
SECRET_KEY = '41v)15_xq6_=(p6-brtewe2x02*^1syr)-53hiwh=)md!7e_8v'
...
ROOT_URLCONF = 'vimeo_assignment.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'vimeo_assignment.wsgi.application'
